...
This README discusses issues unique to NuttX configurations for the Sapog ESC featuring the STMicro STM32F105RCT MCU.  As of this writing, there are one model for Sapog:

  1. Sapog (STM32F105RCT)

Features of the Sapog include:
...
========
  ...
  - STM32F105RCT Pin Usage
  - Sapog-specific Configuration Options
  - LEDs
...
The Sapog board has four LEDs labeled LED1, LED2, LED3 and LED4 on the
...
Sapog-specific Configuration Options//Shenzhou-specific Configuration Options
============================================
    ...
    CONFIG_ARCH_CHIP_name - For use in C code to identify the exact
       ...
       CONFIG_ARCH_CHIP_STM32F105RC=y

    CONFIG_ARCH_BOARD_STM32_CUSTOM_CLOCKCONFIG - Enables special STM32 clock
       configuration features. (!!Sapog 회로도 확인하기)
    ...
    CONFIG_ARCH_BOARD - Identifies the boards/ subdirectory and
       ...
       CONFIG_ARCH_BOARD=sapog (for Sapog ESC)

    CONFIG_ARCH_BOARD_name - For use in C code

       CONFIG_ARCH_BOARD_SAPOG=y//CONFIG_ARCH_BOARD_SHENZHOU=y
  ...
  Sapog CAN Configuration //Shenzhou CAN Configuration
  ...
  Sapog LCD Hardware Configuration//Shenzhou LCD Hardware Configuration
...
Each Sapog configuration is maintained in a sub-directory and //Each Shenzhou configuration is maintained in a sub-directory and
can be selected as follow:

    tools/configure.sh sapog:<subdir> //tools/configure.sh shenzhou:<subdir>
...
Where <subdir> is one of the following:
  ...
  ---
    ...
    2. Enabling the ADC example:
       ...
       The signal selection is hard-coded in boards/arm/stm32/sapog/src/up_adc.c:  The//The signal selection is hard-coded in boards/arm/stm32/shenzhou/src/up_adc.c:  The
